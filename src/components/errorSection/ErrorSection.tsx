...
import {styles} from "./ErrorSectionStyles";
...
const allErrors: ErrorConfig[] = [
    ...
    { text: 'User is already confirmed'},
    { text: 'An account with this email already exists and is confirmed. ' +
            'Please sign in, or reset your password if you don’t remember it.'},
    { text: 'Something happened retrieving your stats'},
    { text: 'Something happened retrieving cause details'},
]
export default function ErrorSection({ errorIndexes, onLinkPress }: Props) {
    return (
